  ...
  useEffect(() => {
    async function getMoviesDetails() {
      try {
        ...
        console.log("Failed to load movie details, please try again");
      } finally {
        setIsLoading(false);
      }
    }
                    ...
                    {movie.spoken_languages &&
                      movie.spoken_languages.length > 0 && (
                        <div>
                          ...
                          <p className="text-white">
                            {movie.spoken_languages
                              .map((langugae) => langugae.english_name)
                              .join(",")}
                          </p>
                        </div>
                      )}
                  ...
                  <div className=" flex mt-8  space-x-2 ">
                    {movie.homepage && (
                      <a
                        ...
                        className="inline-flex items-center bg-neutral-700 hover:bg-neutral-680 text-white px-4 py-2 rounnded transition-colors"
                      >
                        <svg
                          xmlns="https://www.w3.org/2000/svg"
