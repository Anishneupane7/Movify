...
const Navbar = () => {
  ...
  const [showSearchResult, setShowSearchReasult] = useState(false);
        ...
        <div className="flex items-center justify-between">
          ...
          >
            ...
            {showSearchResult &&
              ...
              !isSearching && (
                <div className="absolute right-0 mt-2 w-72 max-w-[90vw] bg-neutral-800 rounded-lg shadow-lg overflow-hidden z-50">
